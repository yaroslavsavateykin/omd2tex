...
\begin{filecontents*}{еремин2013основы.bib}
...
\end{filecontents*}
\addbibresource{еремин2013основы.bib}

\begin{filecontents*}{еремин2007теоретическая.bib}

@article{еремин2007теоретическая,
  title={Теоретическая и математическая химия для школьников}, 
  author={Еремин, Вадим Владимирович},
  journal={{{journal}}},
  number={{{number}}},
  volume={{{volume}}},
  pages={{{pages}}},
...
\end{filecontents*}
\addbibresource{еремин2007теоретическая.bib}
